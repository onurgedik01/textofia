...
<html lang="en">
  ...
  <body>
    ...
    <br /><br />
      <h1 class="mt-5">Textofia - [+] New Note</h1>

<center>

<form action="saveNote.request.sen2001" method="POST">
<textarea class="form-control" rows="4" cols="50" name="notexx"  placeholder="Type something..">
</textarea><br /><br />
