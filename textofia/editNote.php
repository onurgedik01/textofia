...
<html lang="en">
  ...
  <body>
    ...
    <br /><br />
      <h1 class="mt-5">Textofia - [+] Edit Note</h1>
...
$verileriAl = mysql_query("SELECT * FROM notes WHERE noteid='$noteid'");
...
$update = mysql_query("UPDATE notes SET note='$dnote' WHERE noteid='$noteid'");

if($update){
header("Location: edit.note.sen2001?noteid=$noteid&updated=okay");
}
...
<?php
if($_GET["updated"] == "okay"){
echo '<div class="alert alert-success"><i class="fa fa-info"></i> Your note has been updated. <a href="main.sen2001">Click here</a> to go homepage!</div>';
}
?>
...
<textarea class="form-control" rows="4" cols="50" name="notexx">
<?php echo $note; ?>
</textarea><br /><br />
<input type="submit" class="btn-lg btn btn-success" value="Save">
