...
<html lang="en">
  ...
  <body>
    ...
    <header>
      ...
      <div class="container d-flex flex-column flex-md-row justify-content-between">
        ...
        <a class="py-2 d-none d-md-inline-block" href="#">Sign Up</a>
                ...
                <a class="py-2 d-none d-md-inline-block" onclick="alert('You need to login first!');" href="#">My Notes</a>
                <a class="py-2 d-none d-md-inline-block" onclick="alert('You need to login first!');" href="#">Write a New Note</a>
    ...
    <br /><br />
      ...
      <p class="lead">Welcome to Textofia! You can sign in or sign up!</p>
